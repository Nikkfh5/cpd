...
value. At the series level, a trajectory with no true and no predicted change
points is assigned precision, recall, and F1 equal to 1; a trajectory with no
true change points but at least one prediction is counted as a false-positive
case and receives zero precision, recall, and F1.
...
\begin{table}[t]
  ...
  \input{../assets/tables/matching_margin_robustness_leaders.tex}
\end{table}
